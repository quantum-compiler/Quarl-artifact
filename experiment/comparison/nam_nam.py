...
if __name__ == "__main__":
    ...
    for i, fn in enumerate(fns):
        ...
        print(f"{fn}, gate: {gate_cnt}, cnot: {cnot_cnt}, depth: {depth}, nam")

    print("ordered gate count: ")
    for fn in circuit_order:
        if fn + "_after_heavy.qasm" in result_dict:
            print(result_dict[fn + "_after_heavy.qasm"][0])
        else:
            print("-")
    ...
    for fn in circuit_order:
        if fn + "_after_heavy.qasm" in result_dict:
            print(result_dict[fn + "_after_heavy.qasm"][1])
        else:
            print("-")
    ...
    for fn in circuit_order:
        if fn + "_after_heavy.qasm" in result_dict:
            print(result_dict[fn + "_after_heavy.qasm"][2])
        else:
            print("-")
